  ...
  return (
    ...
    <Sidebar2 userRole={localStorage.getItem("role")} />
        ...
        <div className="users">
          ...
          <div className=" flex flex-row w-11/12 bg-gray-100 rounded-xl py-8 shadow-lg ml-12 mt-12">
            ...
            <div className=" flex-1 ">
              <div
                className="circle-menu w-12 h-12 shadow-xl flex items-center justify-center delay-[300ms] duration-[600ms] bg-gray-200"
                data-aos="fade-down"
              >
                <span className="">
                  {" "}
                  <FontAwesomeIcon
                    ...
                    className="text-gray-800 shadow-2xl"
                  />
                </span>
              </div>
              <Link to="/Request">
            ...
            <div className="flex-1 ">
              ...
              >
                <span className="">
                  ...
                  <FontAwesomeIcon
                    icon={faCartShopping}
                    className="text-gray-800shadow-2x"
                  />
                </span>
              </div>
              <Link to="/Report">
      ...
      <div className='flex justify-center py-6 mt-8 shadow-2xl bg-gray-800'><br />
           <h1 className='white-me text-1xl   text-semibold' data-aos="zoom-in-down">Welcome to Finance Dashboard</h1>
        </div>
    </div>
          <Pie />
        </div>
